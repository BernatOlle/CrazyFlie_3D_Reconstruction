...
uri_link_90 = 'radio://0/90/2M/E7E7E7E7E7'
uri_link_80 = 'radio://0/80/2M/E7E7E7E7E7'

uri = uri_helper.uri_from_env(default=uri_link_90)
...
def update_graph(x,y,z,final,fig,i):
    ...
    while final.value == False:
        ...
        sc_red = ax.scatter(round(x_values,2),round(y_values,2),round(z_values,2), c='red', s =70)
...
def go_land(cf,initial_val):
    for lan in land:
        ...
        print("NextPoint")
        time.sleep(1)
    initial_lan = (initial_val[0],initial_val[1]+30,initial_val[2])
    go_to(cf,initial_lan)
    go_to(cf,initial_val)
